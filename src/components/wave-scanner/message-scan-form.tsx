  ...
  return (
    ...
    >
      <div className="space-y-4 p-5 sm:p-6">
        <div>
          <FieldLabel htmlFor="message-text" className="mb-2 text-2sm font-semibold">
            Message to analyze
          </FieldLabel>
          <Textarea
            id="message-text"
            ...
            rows={6}
            autoFocus
            className="min-h-[140px] resize-y rounded-lg border-border bg-surface px-3 py-3 text-sm leading-7 shadow-none placeholder:text-foreground-subtle hover:border-border-strong focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/10 sm:min-h-[160px]"
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <FieldLabel htmlFor="message-source" className="mb-1.5 text-xs font-medium text-foreground-secondary">
              Platform
            </FieldLabel>
            <Select
            ...
            >
              <SelectTrigger className="h-9 w-full rounded-lg border-border bg-surface text-2sm shadow-none">
            ...
            {!sourceOptions.includes(messageSource) && (
              <Input
                ...
                className="mt-2 h-9 rounded-lg border-border bg-surface px-3 text-2sm shadow-none placeholder:text-foreground-subtle"
              />
            )}
          </div>
          <div>
            <FieldLabel htmlFor="message-evidence" className="mb-1.5 text-xs font-medium text-foreground-secondary">
              Additional context
            </FieldLabel>
            <Input
              id="message-evidence"
        ...
        <div>
          <FieldLabel htmlFor="message-attachment" className="mb-1.5 text-xs font-medium text-foreground-secondary">
